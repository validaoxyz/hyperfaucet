...
Sensitive values shown in the demo configs can also be injected at runtime. The local examples document `FAUCET_SECRET`, `FAUCET_PSEUDONYM_KEY`, `FAUCET_STATUS_ADMIN_TOKEN`, `FAUCET_ETH_WALLET_KEY`, `FAUCET_CAPTCHA_SECRET`, `FAUCET_GITHUB_APP_SECRET`, and `FAUCET_PASSPORT_SCORER_API_KEY`.
