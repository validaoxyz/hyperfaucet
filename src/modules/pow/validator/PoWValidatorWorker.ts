...
export class PoWValidatorWorker {
  ...
  private onControlMessage(msg: unknown) {
    if(typeof msg !== "object" || msg === null || Array.isArray(msg))
      return;

    switch((msg as {action?: unknown}).action) {
      case "validate":
        void this.onCtrlValidate((msg as {data: IPoWValidatorValidateRequest}).data);
        break;
    }
  }
